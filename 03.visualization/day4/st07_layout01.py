...
region = 'northwest'
#northwest_df = df.query('region == "northwest"')
northwest_df = df[df['region'] == region]
...
with tab2:    
	...
	with col1:     
		...
		sns.scatterplot(data=northwest_df, x='bmi', y='charges', 
	...
	with col2:
		...
		fig, axes = plt.subplots(2, 1, figsize=(6,10))
		sns.boxplot(data=northwest_df, x='smoker', y='charges', 
              		hue='smoker', ax=axes[0])
		axes[0].set_title('Boxplot: 흡연자와 의료 비용')
  
		sns.boxplot(data=northwest_df, x='sex', y='charges', 
        	         	hue='sex', ax=axes[1])
